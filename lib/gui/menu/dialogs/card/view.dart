    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        ...
        children: [
          ...
          if (currentSavedCard.tag == TagType.hidProx) ...[
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        italian
                            ? 'Analisi credenziale LF'
                            : 'LF credential analysis',
                        style: const TextStyle(fontWeight: FontWeight.bold),
                      ),
                      const SizedBox(height: 8),
                      Text(
                          '${italian ? 'Formato' : 'Format'}: ${getNameForHIDProxType(card.hidType)}'),
                      Text(
                          '${italian ? 'Codice impianto' : 'Facility code'}: ${card.facilityCode}'),
                      Text(
                          '${italian ? 'Numero credenziale' : 'Credential number'}: ${card.credentialNumber}'),
                    ],
                  ),
                ),
              );
