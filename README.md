...
| Funzione | Anteprima |
| --- | --- |
| **1. Connessione al dispositivo** — rilevamento del Chameleon Ultra tramite Bluetooth. | <img src="docs/images/01-connect.png" alt="Connessione Bluetooth al Chameleon Ultra" width="280"> |
